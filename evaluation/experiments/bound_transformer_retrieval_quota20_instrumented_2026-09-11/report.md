...
Retrieval mode: `production hybrid_search with query planner and reranker`; reranker: `qwen3-rerank`; maximum K: `30`; candidates/type: dense `20`, lexical `20`.
...
Average rerank candidates: `64.0`; average rerank stage: `351.6 ms`.
